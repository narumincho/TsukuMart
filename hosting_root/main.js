...
{
	if (region.aa.E === region.am.E)
	{
		return 'on line ' + region.aa.E;
	}
	return 'on lines ' + region.aa.E + ' through ' + region.am.E;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		function done(response) {
			callback(toTask(request.D.a(response)));
		}

		var xhr = new XMLHttpRequest();
		xhr.addEventListener('error', function() { done(elm$http$Http$NetworkError_); });
		xhr.addEventListener('timeout', function() { done(elm$http$Http$Timeout_); });
		xhr.addEventListener('load', function() { done(_Http_toResponse(request.D.b, xhr)); });
		elm$core$Maybe$isJust(request.be) && _Http_track(router, xhr, request.be.a);

		try {
			xhr.open(request.a1, request.M, true);
		} catch (e) {
		...
		request.N.a && xhr.setRequestHeader('Content-Type', request.N.a);
		xhr.send(request.N.b);
...
var elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {a_: index, a0: match, a2: number, bb: submatches};
	});
...
var author$project$Page$LogIn$initModel = author$project$Page$LogIn$LogInPage(
	{
		...
		ac: author$project$Page$LogIn$analysisStudentIdOrEmailAddress('')
	});
...
var author$project$Page$SignUp$initModel = author$project$Page$SignUp$Normal(
	{
		k: author$project$Page$SignUp$StudentHasSAddress(
			{
				X: author$project$Password$passwordFromString(''),
				H: author$project$Page$SignUp$analysisStudentIdOrSAddress('')
			}),
		...
		_List_fromArray(
			[
				...
				author$project$Main$PageExhibition(
					{al: '', aq: _List_Nil, aB: elm$core$Maybe$Nothing, f: ''}),
	...
	function (url, beforePageMaybe) {
		return A2(
			...
			author$project$Main$PageHome(
				author$project$Main$HomePageRecommend(
					{
						F: elm$core$Maybe$Just('指定したページが見つからないのでホームに移動しました')
					})),
			A2(
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{u: false, N: r.N, D: r.D, aW: r.aW, a1: r.a1, bd: r.bd, be: r.be, M: r.M}));
};
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{N: elm$http$Http$emptyBody, D: r.D, aW: _List_Nil, a1: 'GET', bd: elm$core$Maybe$Nothing, be: elm$core$Maybe$Nothing, M: r.M});
};
var author$project$Api$debugDeleteAllUser = function (msg) {
	return elm$http$Http$get(
		{
			D: A2(elm$http$Http$expectStringResponse, msg, author$project$Api$debugDeleteAllUserResponseToResult),
			M: 'http://api.tsukumart.com/v1/debug/user/delete/?all=true'
		});
};
...
var author$project$Api$LogInErrorNoConfirm = 1;
...
var author$project$Api$logInResponseBodyDecoder = elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			...
			function (e) {
				return (e === 'No active confirmed account found with the given credentials') ? elm$core$Result$Err(1) : elm$core$Result$Err(5);
			},
...
var elm$http$Http$post = function (r) {
	return elm$http$Http$request(
		{N: r.N, D: r.D, aW: _List_Nil, a1: 'POST', bd: elm$core$Maybe$Nothing, be: elm$core$Maybe$Nothing, M: r.M});
};
var author$project$Api$logIn = F2(
	function (logInData, msg) {
		return elm$http$Http$post(
			{
				N: elm$http$Http$jsonBody(
					author$project$Api$logInRequestToJson(logInData)),
				D: A2(elm$http$Http$expectStringResponse, msg, author$project$Api$logInResponseToResult),
				M: 'http://api.tsukumart.com/auth/token/'
			});
	});
		...
		return elm$http$Http$post(
			{
				...
				D: A2(elm$http$Http$expectStringResponse, msg, author$project$Api$signUpResponseToResult),
				M: 'http://api.tsukumart.com/auth/signup/'
			});
	});
...
var author$project$Api$signUpConfirm = F2(
	function (_n0, msg) {
		var confirmToken = _n0.aj;
		return elm$http$Http$request(
			{
				N: elm$http$Http$emptyBody,
				D: A2(elm$http$Http$expectStringResponse, msg, author$project$Api$signUpConfirmResponseToResult),
				aW: _List_fromArray(
					[
				...
				M: 'http://api.tsukumart.com/auth/signup/confirm/'
			});
	});
			...
			if (!model.$) {
				...
				return author$project$Page$LogIn$LogInPage(
					_Utils_update(
						r,
						{
							ac: author$project$Page$LogIn$analysisStudentIdOrEmailAddress(string)
						}));
			} else {
				return author$project$Page$LogIn$ForgotPassword;
			}
				...
				switch (msg.$) {
							...
							return author$project$Page$SignUp$Normal(
								{
									k: author$project$Page$SignUp$StudentHasSAddress(
										_Utils_update(
											r,
											{
												H: author$project$Page$SignUp$analysisStudentIdOrSAddress(string)
											})),
									aO: university
								});
						} else {
					...
					case 1:
						...
						if (sAddressAndPassword.$ === 1) {
							...
							return author$project$Page$SignUp$Normal(
								{k: sAddressAndPassword, aO: university});
						}
					case 2:
						var string = msg.a;
						return author$project$Page$SignUp$Normal(
									...
									if (sAddressAndPassword.$ === 1) {
										...
										return author$project$Page$SignUp$NewStudent(
											_Utils_update(
												r,
												{
													X: author$project$Password$passwordFromString(string)
												}));
									} else {
										var r = sAddressAndPassword.a;
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ao: fragment, ap: host, ay: path, aA: port_, aE: protocol, aF: query};
	});
				...
				return _Utils_Tuple2(
					_Utils_update(
						rec,
						{
							a: function () {
								if (!response.$) {
									return author$project$Main$PageHome(
										author$project$Main$HomePageRecommend(
											{
												F: elm$core$Maybe$Just('新規登録できた')
											}));
								} else {
									var e = response.a;
									return author$project$Main$PageSignUp(
				...
				return _Utils_Tuple2(
					function () {
						...
						switch (_n11.$) {
							...
							case 2:
								var _n12 = _n11.a;
								var logInModel = _n12.a;
								var pageMaybe = _n12.b;
								return _Utils_update(
									rec,
									{
				...
				return _Utils_Tuple2(
					function () {
						...
						switch (_n15.$) {
							...
							case 2:
								var _n16 = _n15.a;
								var logInModel = _n16.a;
								var pageMaybe = _n16.b;
								return _Utils_update(
									rec,
									{
										a: author$project$Main$PageLogIn(
...
var author$project$Main$invalidLinkErrorMsg = function (message) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
	...
	function (isWideScreenMode, subPage) {
		return _Utils_Tuple2(
			A2(
				...
				_List_fromArray(
					[
						_Utils_Tuple2(author$project$Main$HomePageRecent, '新着'),
						_Utils_Tuple2(
						author$project$Main$HomePageRecommend(
							{F: elm$core$Maybe$Nothing}),
						'おすすめ'),
						_Utils_Tuple2(author$project$Main$HomePageFree, '0円')
					]),
				function () {
					switch (subPage.$) {
						case 0:
			...
			function () {
				if (subPage.$ === 1) {
					var message = subPage.a.F;
					if (!message.$) {
						var m = message.a;
						return _List_fromArray(
							[
								author$project$Main$invalidLinkErrorMsg(m),
...
var author$project$Page$LogIn$view = function (logInPage) {
	return _List_fromArray(
		[
			...
			function () {
				if (!logInPage.$) {
					var studentIdOrEmailAddress = logInPage.a.ac;
					var password = logInPage.a.X;
...
var author$project$Page$SignUp$getSignUpRequestEmailAddressAndPasswordAndImage = function (sAddressAndPassword) {
	if (!sAddressAndPassword.$) {
		var studentIdOrTsukubaEmailAddress = sAddressAndPassword.a.H;
		var password = sAddressAndPassword.a.X;
...
var author$project$Page$SignUp$getSignUpRequest = F2(
	function (sAddressAndPassword, university) {
		...
		if ((!_n0.a.$) && (!_n0.b.$)) {
			...
			var password = _n0.a.a.X;
			var image = _n0.a.a.aq;
			var universityData = _n0.b.a;
			return elm$core$Maybe$Just(
				{P: emailAddress, aq: image, S: password, aO: universityData});
		} else {
			return elm$core$Maybe$Nothing;
		}
	});
				...
				_Utils_ap(
					...
					function () {
						if (!userSignUpSAddressAndPassword.$) {
							...
							var password = userSignUpSAddressAndPassword.a.X;
							return _List_fromArray(
								[
									elm$html$Html$Events$onClick(
...
var author$project$School$schoolAndDepartmentToJapaneseString = function (schoolAndDepartment) {
	return function (_n1) {
		...
		return {
			O: d,
			a8: author$project$School$schoolToJapaneseString(s)
		};
	}(
		function () {
...
var author$project$Page$SignUp$sentConfirmTokenView = function (signUpResponseErrorMaybe) {
	if (!signUpResponseErrorMaybe.$) {
		if (!signUpResponseErrorMaybe.a) {
			...
			return _List_fromArray(
				[
					elm$html$Html$text('すでにこの認証トークンは送られています')
				]);
		} else {
			var _n2 = signUpResponseErrorMaybe.a;
			return _List_fromArray(
				[
					elm$html$Html$text('認証トークン送信に予期せぬエラーが発生しました')
				]);
		}
	} else {
		return _List_fromArray(
			[
				elm$html$Html$text('認証トークン送信中……')
			]);
	}
};
...
var author$project$Main$main = elm$browser$Browser$application(
	{a$: author$project$Main$init, a3: author$project$Main$UrlChange, a4: author$project$Main$UrlRequest, bc: author$project$Main$subscription, bf: author$project$Main$update, bg: author$project$Main$view});
