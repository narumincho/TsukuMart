...
{
	if (region.ad.H === region.aq.H)
	{
		return 'on line ' + region.ad.H;
	}
	return 'on lines ' + region.ad.H + ' through ' + region.aq.H;
}
...
{
	var flags = 'g';
	if (options.aB) { flags += 'm'; }
	if (options.aj) { flags += 'i'; }
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.az, request.C, true);
		} catch (e) {
...
var author$project$Page$SignUp$initModel = author$project$Page$SignUp$Normal(
	{
		...
		ag: author$project$Page$SignUp$UniversitySchool(author$project$Page$SignUp$UniversitySchoolNone)
	});
		...
		return elm$url$Url$Parser$getFirstMatch(
			parser(
				A5(
					elm$url$Url$Parser$State,
					_List_Nil,
					elm$url$Url$Parser$preparePath(url.aE),
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{u: false, G: r.G, w: r.w, at: r.at, az: r.az, aU: r.aU, aV: r.aV, C: r.C}));
};
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{G: elm$http$Http$emptyBody, w: r.w, at: _List_Nil, az: 'GET', aU: elm$core$Maybe$Nothing, aV: elm$core$Maybe$Nothing, C: r.C});
};
...
var author$project$Api$getUserProfileResponseValueListToResult = F4(
	function (nickName, introduction, departmentMaybe, graduateMaybe) {
		var universityMaybe = function () {
			...
			if (!_n1.a.$) {
				if (!_n1.b.$) {
					...
					return elm$core$Maybe$Just(
						A2(author$project$Api$UniversityGraduateFromTsukuba, graduate, department));
				} else {
					var department = _n1.a.a;
					var _n3 = _n1.b;
					return elm$core$Maybe$Just(
						author$project$Api$UniversitySchool(department));
				}
			} else {
				if (!_n1.b.$) {
					var _n2 = _n1.a;
		...
		if (!universityMaybe.$) {
			var university = universityMaybe.a;
			return elm$core$Result$Ok(
				{a6: introduction, Y: nickName, ag: university});
		} else {
			return elm$core$Result$Err(0);
		}
	});
...
var elm$http$Http$post = function (r) {
	return elm$http$Http$request(
		{G: r.G, w: r.w, at: _List_Nil, az: 'POST', aU: elm$core$Maybe$Nothing, aV: elm$core$Maybe$Nothing, C: r.C});
};
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {as: fragment, au: host, aE: path, aG: port_, aK: protocol, aL: query};
	});
								...
								return _Utils_update(
									rec,
									{
										y: author$project$Main$LogInStateOk(
											{ah: access, T: elm$core$Maybe$Nothing, ab: refresh}),
	...
	function (sAddressAndPassword, university, nickName) {
		...
		if ((!_n0.a.$) && (!_n0.b.$)) {
			...
			return ((1 <= elm$core$String$length(nickName)) && (elm$core$String$length(nickName) <= 50)) ? elm$core$Maybe$Just(
				{P: emailAddress, av: image, Y: nickName, S: password, ag: universityData}) : elm$core$Maybe$Nothing;
		} else {
			return elm$core$Maybe$Nothing;
		}
	});
								...
								elm$core$Tuple$mapSecond(
									elm$html$Html$map(
										function (s) {
											return author$project$Page$SignUp$EmitChangePage(
												author$project$Page$SignUp$Normal(
													{Y: nickName, i: sAddressAndPassword, ag: s}));
										})),
	...
	var _n0 = function () {
		switch (userSignUpPage.$) {
			case 0:
				...
				var university = userSignUpPage.a.ag;
