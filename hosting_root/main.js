...
var author$project$Main$init = F3(
	function (_n0, url, key) {
		...
		return _Utils_Tuple2(
			{
				as: key,
				S: author$project$Main$LogInStateNone,
		...
		switch (msg.$) {
			...
			case 11:
				...
				return _Utils_Tuple2(
					function () {
						if (!logInResponse.$) {
							var access = logInResponse.a.ae;
							var refresh = logInResponse.a._;
							...
							if (!pageMaybe.$) {
								...
								return _Utils_update(
									rec,
									{
										S: author$project$Main$LogInStateOk(
											{ae: access, _: refresh}),
...
var author$project$Page$SignUp$getSignUpRequest = F2(
	function (sAddressAndPassword, university) {
		...
		if ((!_n0.a.$) && (!_n0.b.$)) {
			...
			return elm$core$Maybe$Just(
				{P: emailAddress, ar: image, T: password, aP: universityData});
		} else {
			return elm$core$Maybe$Nothing;
		}
	});
