...
{
	if (region.ab.G === region.ao.G)
	{
		return 'on line ' + region.ab.G;
	}
	return 'on lines ' + region.ab.G + ' through ' + region.ao.G;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.a2, request.S, true);
		} catch (e) {
	...
	k: author$project$Page$SignUp$StudentHasSAddress(
		{
			...
			I: author$project$Page$SignUp$analysisStudentIdOrSAddress('')
		}),
	bg: author$project$Page$SignUp$UniversitySchool(author$project$Page$SignUp$UniversitySchoolNone)
};
		...
		_List_fromArray(
			[
				...
				author$project$Main$PageExhibition(
					{an: '', as: _List_Nil, aD: elm$core$Maybe$Nothing, f: ''}),
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{x: false, N: r.N, P: r.P, aX: r.aX, a2: r.a2, be: r.be, bf: r.bf, S: r.S}));
};
var elm$http$Http$post = function (r) {
	return elm$http$Http$request(
		{N: r.N, P: r.P, aX: _List_Nil, a2: 'POST', be: elm$core$Maybe$Nothing, bf: elm$core$Maybe$Nothing, S: r.S});
};
		...
		return elm$http$Http$post(
			{
				...
				P: A2(elm$http$Http$expectStringResponse, msg, author$project$Api$logInResponseToResult),
				S: 'http://api.tsukumart.com/auth/token/'
			});
	});
		...
		return elm$http$Http$post(
			{
				...
				P: A2(elm$http$Http$expectStringResponse, msg, author$project$Api$signUpResponseToResult),
				S: 'http://api.tsukumart.com/auth/signup/'
			});
	});
		...
		return elm$http$Http$request(
			{
				...
				P: A2(elm$http$Http$expectStringResponse, msg, author$project$Api$signUpConfirmResponseToResult),
				aX: _List_fromArray(
					[
				...
				S: 'http://api.tsukumart.com/auth/signup/confirm/'
			});
	});
					...
					return {
						k: author$project$Page$SignUp$StudentHasSAddress(
							_Utils_update(
								r,
								{
									I: author$project$Page$SignUp$analysisStudentIdOrSAddress(string)
								})),
						bg: university
					};
				} else {
					...
					return {
						k: author$project$Page$SignUp$NewStudent(
							_Utils_update(
								r,
								{
									O: author$project$Page$SignUp$analysisEmailAddress(string)
								})),
						bg: university
					};
				}
					...
					return {
						k: author$project$Page$SignUp$NewStudent(
							_Utils_update(
								r,
								{
									Q: elm$core$Maybe$Just(dataUrlString)
								})),
						bg: university
					};
				} else {
					return {k: sAddressAndPassword, bg: university};
				}
			default:
				var string = msg.a;
				return {
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aq: fragment, ar: host, aA: path, aC: port_, aG: protocol, aH: query};
	});
...
var author$project$Main$update = F2(
	function (msg, _n0) {
		...
		switch (msg.$) {
			...
			case 7:
				...
				return _Utils_Tuple2(
					_Utils_update(
						rec,
						{
							a: A2(author$project$Main$PageSendSignUpEmail, signUpData.O, elm$core$Maybe$Nothing)
						}),
			...
			default:
				var _n16 = rec.a;
				if (((_n16.$ === 7) && (!_n16.b.$)) && (!_n16.b.a.$)) {
					var token = _n16.b.a.a;
					return _Utils_Tuple2(
						rec,
						A2(
			...
			if (!_n0.b.$) {
				switch (_n0.a.$) {
					case 1:
						...
						return elm$core$Maybe$Just(
							{
								O: author$project$EmailAddress$fromSAddress(
...
var author$project$Page$SignUp$getSignUpRequestEmailAddressAndPasswordAndImage = function (sAddressAndPassword) {
	if (!sAddressAndPassword.$) {
		var studentIdOrTsukubaEmailAddress = sAddressAndPassword.a.I;
			...
			if (!_n1.b.$) {
				switch (_n1.a.$) {
					...
					case 2:
						...
						return elm$core$Maybe$Just(
							{
								O: author$project$EmailAddress$fromSAddress(sAddress),
								as: elm$core$Maybe$Nothing,
								Y: pass
							});
					default:
		...
		var emailAddress = sAddressAndPassword.a.O;
		var password = sAddressAndPassword.a.Y;
		var imageUrl = sAddressAndPassword.a.Q;
...
var author$project$Page$SignUp$getSignUpRequest = function (_n0) {
	var sAddressAndPassword = _n0.k;
	var university = _n0.bg;
	var _n1 = _Utils_Tuple2(
	...
	if ((!_n1.a.$) && (!_n1.b.$)) {
		var emailAddress = _n1.a.a.O;
		var password = _n1.a.a.Y;
		var image = _n1.a.a.as;
		var universityData = _n1.b.a;
		return elm$core$Maybe$Just(
			{O: emailAddress, as: image, R: password, bg: universityData});
	} else {
		return elm$core$Maybe$Nothing;
	}
};
							...
							return _List_fromArray(
								[
									...
									author$project$Page$SignUp$NewStudent(
										{
											O: author$project$EmailAddress$fromCharList(_List_Nil),
...
var author$project$Page$SignUp$view = function (userSignUpPage) {
	...
	var university = userSignUpPage.bg;
	return _List_fromArray(
		[
			A2(
			elm$html$Html$div,
								...
								_List_fromArray(
									[
										...
										author$project$Page$SignUp$signUpSubmitButton(
											author$project$Page$SignUp$getSignUpRequest(userSignUpPage)))
									])))))
				]))
		]);
};
...
var author$project$Main$main = elm$browser$Browser$application(
	{a0: author$project$Main$init, a4: author$project$Main$UrlChange, a5: author$project$Main$UrlRequest, bd: author$project$Main$subscription, bh: author$project$Main$update, bi: author$project$Main$view});
