...
{
	if (region.ac.I === region.ao.I)
	{
		return 'on line ' + region.ac.I;
	}
	return 'on lines ' + region.ac.I + ' through ' + region.ao.I;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.ax, request.C, true);
		} catch (e) {
...
var author$project$Page$Exhibition$initModel = {an: '', at: _List_Nil, aG: elm$core$Maybe$Nothing, bj: ''};
...
var author$project$Page$SignUp$initModel = author$project$Page$SignUp$Normal(
	{
		...
		aV: author$project$Page$SignUp$UniversitySchool(author$project$Page$SignUp$UniversitySchoolNone)
	});
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{u: false, G: r.G, w: r.w, ar: r.ar, ax: r.ax, aT: r.aT, aU: r.aU, C: r.C}));
};
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{G: elm$http$Http$emptyBody, w: r.w, ar: _List_Nil, ax: 'GET', aT: elm$core$Maybe$Nothing, aU: elm$core$Maybe$Nothing, C: r.C});
};
...
var elm$http$Http$post = function (r) {
	return elm$http$Http$request(
		{G: r.G, w: r.w, ar: _List_Nil, ax: 'POST', aT: elm$core$Maybe$Nothing, aU: elm$core$Maybe$Nothing, C: r.C});
};
					...
					case 5:
						...
						return author$project$Page$SignUp$Normal(
							_Utils_update(
								rec,
								{
									aB: elm$core$String$trim(nickName)
								}));
					default:
						return model;
				}
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aq: fragment, as: host, aD: path, aF: port_, aJ: protocol, aK: query};
	});
								...
								return _Utils_update(
									rec,
									{
										y: author$project$Main$LogInStateOk(
											{af: access, T: elm$core$Maybe$Nothing, aa: refresh}),
	...
	function (sAddressAndPassword, university, nickName) {
		...
		if ((!_n0.a.$) && (!_n0.b.$)) {
			...
			return ((1 <= elm$core$String$length(nickName)) && (elm$core$String$length(nickName) <= 50)) ? elm$core$Maybe$Just(
				{P: emailAddress, at: image, aB: nickName, S: password, aV: universityData}) : elm$core$Maybe$Nothing;
		} else {
			return elm$core$Maybe$Nothing;
		}
	});
								...
								elm$core$Tuple$mapSecond(
									elm$html$Html$map(
										function (s) {
											return author$project$Page$SignUp$EmitChangePage(
												author$project$Page$SignUp$Normal(
													{aB: nickName, i: sAddressAndPassword, aV: s}));
										})),
	...
	var _n0 = function () {
		switch (userSignUpPage.$) {
			case 0:
				...
				var university = userSignUpPage.a.aV;
				var nickName = userSignUpPage.a.aB;
				return _Utils_Tuple2(
					'新規登録',
