...
{
	if (region.ae.H === region.ar.H)
	{
		return 'on line ' + region.ae.H;
	}
	return 'on lines ' + region.ae.H + ' through ' + region.ar.H;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aA, request.C, true);
		} catch (e) {
...
var author$project$Page$Exhibition$initModel = {aq: '', aw: _List_Nil, aI: elm$core$Maybe$Nothing, bl: ''};
...
var elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {a7: index, ba: match, bb: number, bj: submatches};
	});
...
var author$project$Page$LogIn$initModel = author$project$Page$LogIn$LogInPage(
	{
		...
		U: false,
		ag: author$project$Page$LogIn$analysisStudentIdOrEmailAddress('')
	});
		...
		return elm$url$Url$Parser$getFirstMatch(
			parser(
				A5(
					elm$url$Url$Parser$State,
					_List_Nil,
					elm$url$Url$Parser$preparePath(url.aF),
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{u: false, G: r.G, w: r.w, au: r.au, aA: r.aA, aV: r.aV, aW: r.aW, C: r.C}));
};
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{G: elm$http$Http$emptyBody, w: r.w, au: _List_Nil, aA: 'GET', aV: elm$core$Maybe$Nothing, aW: elm$core$Maybe$Nothing, C: r.C});
};
...
var author$project$Data$University$universityFromIdString = function (_n0) {
	var graduateMaybe = _n0.a3;
	var departmentMaybe = _n0.a$;
	var _n1 = _Utils_Tuple2(
...
var author$project$Api$getUserProfileResponseValueListToResult = F4(
	function (nickName, introduction, departmentMaybe, graduateMaybe) {
		var _n0 = author$project$Data$University$universityFromIdString(
			{a$: departmentMaybe, a3: graduateMaybe});
		if (!_n0.$) {
...
var elm$http$Http$post = function (r) {
	return elm$http$Http$request(
		{G: r.G, w: r.w, au: _List_Nil, aA: 'POST', aV: elm$core$Maybe$Nothing, aW: elm$core$Maybe$Nothing, C: r.C});
};
...
var author$project$Page$Exhibition$InputExhibitionImage = elm$core$Basics$identity;
var author$project$Page$Exhibition$update = F2(
	function (msg, _n0) {
		var rec = _n0;
		var dataUrlList = msg;
...
var author$project$Page$LogIn$SendLogIn = {$: 2};
var author$project$Page$LogIn$StopSendLogIn = {$: 3};
				...
				if (!model.$) {
					...
					return author$project$Page$LogIn$LogInPage(
						_Utils_update(
							r,
							{
								ag: author$project$Page$LogIn$analysisStudentIdOrEmailAddress(string)
							}));
				} else {
					return author$project$Page$LogIn$ForgotPassword;
				}
				...
				switch (msg.$) {
					...
					case 1:
						...
						if (_n3.$ === 1) {
							...
							return author$project$Page$SignUp$Normal(rec);
						}
					case 2:
						var string = msg.a;
						return author$project$Page$SignUp$Normal(
										...
										if (_n4.$ === 1) {
											...
											return author$project$Page$SignUp$NewStudent(
												_Utils_update(
													r,
													{
														_: author$project$Data$Password$passwordFromString(string)
													}));
										} else {
											var r = _n4.a;
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {at: fragment, av: host, aF: path, aH: port_, aL: protocol, aM: query};
	});
							...
							return _Utils_update(
								rec,
								{
									a: author$project$Main$PageLogIn(
										_Utils_Tuple2(
											A2(author$project$Page$LogIn$update, author$project$Page$LogIn$SendLogIn, logInPageModel),
											nextPage))
								});
						} else {
							return rec;
							...
							if (_n17.$ === 2) {
								...
								return _Utils_update(
									rec,
									{
										...
										a: author$project$Main$PageLogIn(
											_Utils_Tuple2(
												A2(author$project$Page$LogIn$update, author$project$Page$LogIn$StopSendLogIn, logInPageModel),
												nextPage))
									});
							} else {
								return _Utils_update(
							...
							return _Utils_update(
								rec,
								{
									a: author$project$Main$PageSignUp(
										A2(
											author$project$Page$SignUp$update,
											author$project$Page$SignUp$InputNickName(string),
											signUpModel))
								});
						} else {
							return rec;
				...
				return _Utils_Tuple2(
					function () {
						...
						switch (_n23.$) {
							...
							case 6:
								var exhibitionPageModel = _n23.a;
								return _Utils_update(
									rec,
									{
			...
			case 17:
				...
				return _Utils_Tuple2(
					function () {
						var _n24 = rec.a;
						if (_n24.$ === 6) {
							var exhibitionPageModel = _n24.a;
							return _Utils_update(
								rec,
								{
									a: author$project$Main$PageExhibition(
										A2(author$project$Page$Exhibition$update, urlStringList, exhibitionPageModel))
								});
						} else {
							return rec;
						}
				...
				return _Utils_Tuple2(
					function () {
						...
						switch (_n25.$) {
							...
							case 2:
								var _n26 = _n25.a;
								var logInModel = _n26.a;
								var pageMaybe = _n26.b;
								return _Utils_update(
									rec,
									{
										a: author$project$Main$PageLogIn(
...
var author$project$Main$exhibitionPageEmitToMsg = function (emit) {
	var string = emit;
...
var author$project$Main$DeleteAllUser = {$: 20};
var author$project$Main$InputNickName = function (a) {
	return {$: 15, a: a};
};
...
var author$project$Main$signUpPageEmitToMsg = function (emit) {
	switch (emit.$) {
		...
		default:
			var string = emit.a;
			return author$project$Main$InputNickName(string);
	}
};
...
var author$project$Page$Exhibition$EmitInputExhibitionImage = elm$core$Basics$identity;
...
var author$project$Page$Exhibition$photoView = function (imageUrlList) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				...
				[
					...
					_List_fromArray(
						[
							...
							elm$html$Html$Events$on,
							'change',
							elm$json$Json$Decode$succeed('exhibitionView-photo-input'))
						]),
					_List_Nil)
				]),
			function () {
...
var author$project$Page$Exhibition$titleAndDescriptionView = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
	...
	return _Utils_Tuple2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						author$project$Page$Exhibition$photoView(image),
						author$project$Page$Exhibition$titleAndDescriptionView,
						author$project$Page$Exhibition$priceView(price)
					]))
			]));
};
var author$project$Data$Goods$getComplete = function (_n0) {
	var complete = _n0.am;
	return complete;
};
var author$project$Data$Goods$getCondition = function (_n0) {
	var condition = _n0.an;
	return condition;
};
...
var author$project$Data$Goods$getImage = function (_n0) {
	var image = _n0.aw;
	return image;
};
var author$project$Data$Goods$getLike = function (_n0) {
	var like = _n0.ay;
	return like;
};
var author$project$Data$Goods$getLocation = function (_n0) {
	var location = _n0.az;
	return location;
};
					...
					[
						...
						_List_fromArray(
							[
								...
								author$project$Data$Goods$getLocation(goods)),
								A2(
								elm$html$Html$div,
								_List_Nil,
								_List_fromArray(
									[
										elm$html$Html$text(
										author$project$Data$Goods$getComplete(goods) ? '売却済み' : 'まだ売れていない')
									]))
							])),
						A2(
...
var author$project$Page$LogIn$logInButton = F2(
...
var author$project$SiteMap$signUpUrl = '/signup';
...
var author$project$Page$LogIn$logInView = F3(
	function (analysisStudentIdOrEmailAddressResult, password, sending) {
		return _List_fromArray(
			[
				A2(
				elm$html$Html$div,
...
var author$project$Page$LogIn$view = function (logInPage) {
	return _List_fromArray(
		[
			...
			function () {
				if (!logInPage.$) {
					var studentIdOrEmailAddress = logInPage.a.ag;
...
var author$project$Page$SignUp$EmitInputNickName = function (a) {
	return {$: 7, a: a};
};
						...
						[
							...
							_List_fromArray(
								[
									...
									elm$html$Html$Events$onInput(author$project$Page$SignUp$EmitInputNickName)
								]),
							_List_Nil)
						]),
								...
								elm$core$Tuple$mapSecond(
									elm$html$Html$map(
										function (s) {
											return author$project$Page$SignUp$EmitChangePage(
												author$project$Page$SignUp$Normal(
													{Y: nickName, i: sAddressAndPassword, ah: s}));
										})),
	...
	var _n0 = function () {
		switch (userSignUpPage.$) {
			case 0:
				...
				var university = userSignUpPage.a.ah;
				var nickName = userSignUpPage.a.Y;
				return _Utils_Tuple2(
					'新規登録',
		...
		switch (page.$) {
			...
			case 6:
				...
				return A3(
					...
					elm$core$List$map(
						elm$html$Html$map(author$project$Main$exhibitionPageEmitToMsg)),
					author$project$Page$Exhibition$view(subPage));
			case 3:
				var subPage = page.a;
				return A2(
					elm$core$Tuple$mapFirst,
...
var author$project$Main$main = elm$browser$Browser$application(
	{a8: author$project$Main$init, bc: author$project$Main$UrlChange, bd: author$project$Main$UrlRequest, bk: author$project$Main$subscription, bm: author$project$Main$update, bn: author$project$Main$view});
