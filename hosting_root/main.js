...
{
	if (region.ab.F === region.an.F)
	{
		return 'on line ' + region.ab.F;
	}
	return 'on lines ' + region.ab.F + ' through ' + region.an.F;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.a2, request.M, true);
		} catch (e) {
...
var elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {a$: index, a1: match, a3: number, bc: submatches};
	});
...
var author$project$Page$LogIn$initModel = author$project$Page$LogIn$LogInPage(
	{
		...
		ad: author$project$Page$LogIn$analysisStudentIdOrEmailAddress('')
	});
...
var author$project$Page$SignUp$initModel = author$project$Page$SignUp$Normal(
	{
		k: author$project$Page$SignUp$StudentHasSAddress(
			{
				Y: author$project$Password$passwordFromString(''),
				H: author$project$Page$SignUp$analysisStudentIdOrSAddress('')
			}),
		aP: author$project$Page$SignUp$UniversitySchool(author$project$Page$SignUp$UniversitySchoolNone)
	});
		...
		_List_fromArray(
			[
				...
				author$project$Main$PageExhibition(
					{am: '', ar: _List_Nil, aC: elm$core$Maybe$Nothing, f: ''}),
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{v: false, N: r.N, E: r.E, aX: r.aX, a2: r.a2, be: r.be, bf: r.bf, M: r.M}));
};
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{N: elm$http$Http$emptyBody, E: r.E, aX: _List_Nil, a2: 'GET', be: elm$core$Maybe$Nothing, bf: elm$core$Maybe$Nothing, M: r.M});
};
var author$project$Api$debugDeleteAllUser = function (msg) {
	return elm$http$Http$get(
		{
			E: A2(elm$http$Http$expectStringResponse, msg, author$project$Api$debugDeleteAllUserResponseToResult),
...
var elm$http$Http$post = function (r) {
	return elm$http$Http$request(
		{N: r.N, E: r.E, aX: _List_Nil, a2: 'POST', be: elm$core$Maybe$Nothing, bf: elm$core$Maybe$Nothing, M: r.M});
};
		...
		return elm$http$Http$post(
			{
				...
				E: A2(elm$http$Http$expectStringResponse, msg, author$project$Api$logInResponseToResult),
		...
		return elm$http$Http$post(
			{
				...
				E: A2(elm$http$Http$expectStringResponse, msg, author$project$Api$signUpResponseToResult),
...
var author$project$Api$signUpConfirm = F2(
	function (_n0, msg) {
		var confirmToken = _n0.ak;
		return elm$http$Http$request(
			{
				N: elm$http$Http$emptyBody,
				E: A2(elm$http$Http$expectStringResponse, msg, author$project$Api$signUpConfirmResponseToResult),
				aX: _List_fromArray(
					[
			...
			if (!model.$) {
				...
				return author$project$Page$LogIn$LogInPage(
					_Utils_update(
						r,
						{
							ad: author$project$Page$LogIn$analysisStudentIdOrEmailAddress(string)
						}));
			} else {
				return author$project$Page$LogIn$ForgotPassword;
			}
...
var author$project$Page$SignUp$sentSignUpDataModel = function (emailAddress) {
				...
				switch (msg.$) {
					...
					case 1:
						...
						if (sAddressAndPassword.$ === 1) {
							...
							return author$project$Page$SignUp$Normal(
								{k: sAddressAndPassword, aP: university});
						}
					case 2:
						var string = msg.a;
						return author$project$Page$SignUp$Normal(
									...
									if (sAddressAndPassword.$ === 1) {
										...
										return author$project$Page$SignUp$NewStudent(
											_Utils_update(
												r,
												{
													Y: author$project$Password$passwordFromString(string)
												}));
									} else {
										var r = sAddressAndPassword.a;
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ap: fragment, aq: host, az: path, aB: port_, aF: protocol, aG: query};
	});
					...
					_Utils_update(
						rec,
						{
							a: author$project$Main$PageSignUp(
								author$project$Page$SignUp$sentSignUpDataModel(signUpData.P))
						}),
				...
				return _Utils_Tuple2(
					function () {
						...
						switch (_n10.$) {
							...
							case 2:
								var _n11 = _n10.a;
								var logInModel = _n11.a;
								var pageMaybe = _n11.b;
								return _Utils_update(
									rec,
									{
				...
				return _Utils_Tuple2(
					function () {
						...
						switch (_n14.$) {
							...
							case 2:
								var _n15 = _n14.a;
								var logInModel = _n15.a;
								var pageMaybe = _n15.b;
								return _Utils_update(
									rec,
									{
										a: author$project$Main$PageLogIn(
...
var author$project$Page$LogIn$view = function (logInPage) {
	return _List_fromArray(
		[
			...
			function () {
				if (!logInPage.$) {
					var studentIdOrEmailAddress = logInPage.a.ad;
					var password = logInPage.a.Y;
...
var author$project$Page$SignUp$getSignUpRequestEmailAddressAndPasswordAndImage = function (sAddressAndPassword) {
	if (!sAddressAndPassword.$) {
		...
		var password = sAddressAndPassword.a.Y;
...
var author$project$Page$SignUp$getSignUpRequest = F2(
	function (sAddressAndPassword, university) {
		...
		if ((!_n0.a.$) && (!_n0.b.$)) {
			...
			var password = _n0.a.a.Y;
			var image = _n0.a.a.ar;
			var universityData = _n0.b.a;
			return elm$core$Maybe$Just(
				{P: emailAddress, ar: image, S: password, aP: universityData});
		} else {
			return elm$core$Maybe$Nothing;
		}
	});
				...
				_Utils_ap(
					...
					function () {
						if (!userSignUpSAddressAndPassword.$) {
							...
							var password = userSignUpSAddressAndPassword.a.Y;
							return _List_fromArray(
								[
									elm$html$Html$Events$onClick(
...
var author$project$School$schoolAndDepartmentToJapaneseString = function (schoolAndDepartment) {
	return function (_n1) {
		...
		return {
			O: d,
			a9: author$project$School$schoolToJapaneseString(s)
		};
	}(
		function () {
...
var author$project$Page$SignUp$view = function (userSignUpPage) {
	return _Utils_Tuple2(
		author$project$Tab$Single('新規登録'),
		_List_fromArray(
			[
				A2(
				elm$html$Html$div,
				...
				function () {
					switch (userSignUpPage.$) {
						case 0:
							...
							var university = userSignUpPage.a.aP;
							return A2(author$project$Page$SignUp$normalView, sAddressAndPassword, university);
						case 3:
						...
						case 1:
							...
							return A2(author$project$Page$SignUp$sendSignUpEmailView, emailAddress, maybe);
						default:
							var maybe = userSignUpPage.a;
							return _List_Nil;
					}
				}())
			]));
...
var author$project$Main$main = elm$browser$Browser$application(
	{a0: author$project$Main$init, a4: author$project$Main$UrlChange, a5: author$project$Main$UrlRequest, bd: author$project$Main$subscription, bg: author$project$Main$update, bh: author$project$Main$view});
