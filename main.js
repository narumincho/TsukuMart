...
{
	if (region._.F === region.ai.F)
	{
		return 'on line ' + region._.F;
	}
	return 'on lines ' + region._.F + ' through ' + region.ai.F;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aZ, request.S, true);
		} catch (e) {
...
var elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {aV: index, aY: match, a$: number, a8: submatches};
	});
		...
		_List_fromArray(
			[
				...
				author$project$Main$PageExhibition(
					{aN: '', am: _List_Nil, a3: elm$core$Maybe$Nothing, f: ''}),
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{w: false, N: r.N, P: r.P, aR: r.aR, aZ: r.aZ, ba: r.ba, bb: r.bb, S: r.S}));
};
var elm$http$Http$post = function (r) {
	return elm$http$Http$request(
		{N: r.N, P: r.P, aR: _List_Nil, aZ: 'POST', ba: elm$core$Maybe$Nothing, bb: elm$core$Maybe$Nothing, S: r.S});
};
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ak: fragment, al: host, as: path, au: port_, ax: protocol, ay: query};
	});
...
var author$project$Main$main = elm$browser$Browser$application(
	{aW: author$project$Main$init, a0: author$project$Main$UrlChange, a1: author$project$Main$UrlRequest, a9: author$project$Main$subscription, bc: author$project$Main$update, bd: author$project$Main$view});
