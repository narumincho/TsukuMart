...
var author$project$Main$invalidLinkErrorMsg = A2(
	...
	_List_fromArray(
		[
			elm$html$Html$text('指定したページが見つからなかったのでホームに移動しました')
		]));
