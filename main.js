...
{
	if (region.ab.H === region.an.H)
	{
		return 'on line ' + region.ab.H;
	}
	return 'on lines ' + region.ab.H + ' through ' + region.an.H;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.a1, request.U, true);
		} catch (e) {
					...
					author$project$Main$UserSignUpPageStudentHasSAddress(
						{
							...
							J: author$project$Main$analysisStudentIdOrSAddress('')
						})),
					...
					author$project$Main$LogInPage(
						{
							...
							ad: author$project$Main$analysisStudentIdOrEmailAddress('')
						})),
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{y: false, P: r.P, R: r.R, aW: r.aW, a1: r.a1, bc: r.bc, bd: r.bd, U: r.U}));
};
var elm$http$Http$post = function (r) {
	return elm$http$Http$request(
		{P: r.P, R: r.R, aW: _List_Nil, a1: 'POST', bc: elm$core$Maybe$Nothing, bd: elm$core$Maybe$Nothing, U: r.U});
};
												...
												a: author$project$Main$PageSignUp(
													author$project$Main$UserSignUpPageStudentHasSAddress(
														_Utils_update(
															r,
															{
																J: author$project$Main$analysisStudentIdOrSAddress(string)
															})))
											});
									} else {
										var r = _n10.a.a;
												...
												a: author$project$Main$PageLogIn(
													author$project$Main$LogInPage(
														_Utils_update(
															r,
															{
																ad: author$project$Main$analysisStudentIdOrEmailAddress(string)
															})))
											});
									} else {
										break _n10$3;
...
var author$project$Main$getSignUpData = function (userSignUpPage) {
	if (!userSignUpPage.$) {
		var studentIdOrTsukubaEmailAddress = userSignUpPage.a.J;
		...
		var emailAddress = userSignUpPage.a.Q;
		var password = userSignUpPage.a.g;
		...
		var _n0 = function () {
			switch (page.$) {
				...
				case 1:
					var subPage = page.a;
					return {
						l: author$project$Main$userSignUpView(subPage),
						n: author$project$Main$TabSingle('新規登録')
					};
				case 2:
					var subPage = page.a;
					return {
						l: author$project$Main$userLogInView(subPage),
				...
				case 7:
					...
					var response = page.b;
					return {
						l: A2(author$project$Main$sendSignUpEmailView, emailAddress, response),
						n: author$project$Main$TabNone
					};
				default:
					var goods = page.a;
					return {
						l: author$project$Main$goodsView(goods),
						n: author$project$Main$TabNone
					};
			}
		}();
