...
{
	if (region.af.L === region.av.L)
	{
		return 'on line ' + region.af.L;
	}
	return 'on lines ' + region.af.L + ' through ' + region.av.L;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.bq, request.X, true);
		} catch (e) {
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { bj: 'hidden', bd: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { bj: 'mozHidden', bd: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { bj: 'msHidden', bd: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { bj: 'webkitHidden', bd: 'webkitvisibilitychange' }
		: { bj: 'hidden', bd: 'visibilitychange' };
}
...
var elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {bm: index, bp: match, br: number, bz: submatches};
	});
		...
		_List_fromArray(
			[
				...
				author$project$Main$PageExhibition(
					{at: '', aC: _List_Nil, aQ: elm$core$Maybe$Nothing, j: ''}),
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{C: false, S: r.S, U: r.U, bi: r.bi, bq: r.bq, bB: r.bB, bC: r.bC, X: r.X}));
};
var elm$http$Http$post = function (r) {
	return elm$http$Http$request(
		{S: r.S, U: r.U, bi: _List_Nil, bq: 'POST', bB: elm$core$Maybe$Nothing, bC: elm$core$Maybe$Nothing, X: r.X});
};
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {az: fragment, aB: host, aN: path, aP: port_, aV: protocol, aW: query};
	});
...
var author$project$Main$main = elm$browser$Browser$application(
	{bn: author$project$Main$init, bs: author$project$Main$UrlChange, bt: author$project$Main$UrlRequest, bA: author$project$Main$subscription, bD: author$project$Main$update, bE: author$project$Main$view});
