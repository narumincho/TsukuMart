...
{
	if (region.am.H === region.ax.H)
	{
		return 'on line ' + region.am.H;
	}
	return 'on lines ' + region.am.H + ' through ' + region.ax.H;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		function done(response) {
			callback(toTask(request.k.a(response)));
		}

		var xhr = new XMLHttpRequest();
		xhr.addEventListener('error', function() { done(elm$http$Http$NetworkError_); });
		xhr.addEventListener('timeout', function() { done(elm$http$Http$Timeout_); });
		xhr.addEventListener('load', function() { done(_Http_toResponse(request.k.b, xhr)); });
		elm$core$Maybe$isJust(request.Y) && _Http_track(router, xhr, request.Y.a);

		try {
			xhr.open(request.V, request.n, true);
		} catch (e) {
...
var author$project$Data$Goods$Acceptable = 4;
var author$project$Data$Goods$Good = 3;
var author$project$Data$Goods$Junk = 5;
var author$project$Data$Goods$LikeNew = 1;
var author$project$Data$Goods$New = 0;
var author$project$Data$Goods$VeryGood = 2;
var author$project$Data$Goods$conditionAll = _List_fromArray(
	[0, 1, 2, 3, 4, 5]);
var author$project$Data$Goods$conditionToIdString = function (condition) {
	switch (condition) {
		case 0:
			return 'New';
		case 1:
...
var author$project$Data$Goods$conditionFromStringLoop = F2(
	function (idString, conditionList) {
		...
		while (true) {
			if (conditionList.b) {
				...
				if (_Utils_eq(
					author$project$Data$Goods$conditionToIdString(x),
					idString)) {
...
var author$project$Data$Goods$conditionFromString = function (idString) {
	return A2(author$project$Data$Goods$conditionFromStringLoop, idString, author$project$Data$Goods$conditionAll);
};
...
var author$project$Api$conditionDecoder = A2(
	...
	function (idString) {
		var _n0 = author$project$Data$Goods$conditionFromString(idString);
		if (!_n0.$) {
			var condition = _n0.a;
			...
			return elm$json$Json$Decode$fail(
				'I can\'t understand conditionId=\"' + (idString + ('\" except \"' + (A2(
					elm$core$String$join,
					'\" or \"',
					A2(elm$core$List$map, author$project$Data$Goods$conditionToIdString, author$project$Data$Goods$conditionAll)) + '\"'))));
		}
	},
	elm$json$Json$Decode$string);
var author$project$Data$Goods$Draft = 0;
var author$project$Data$Goods$Selling = 1;
var author$project$Data$Goods$SoldOut = 3;
var author$project$Data$Goods$Trading = 2;
var author$project$Data$Goods$statusAll = _List_fromArray(
	[0, 1, 2, 3]);
var author$project$Data$Goods$statusToIdString = function (status) {
	switch (status) {
		case 0:
			return 'draft';
		case 1:
...
var author$project$Data$Goods$statusFromIdStringLoop = F2(
	function (idString, statusList) {
		...
		while (true) {
			if (statusList.b) {
				...
				var xs = statusList.b;
				if (_Utils_eq(
					author$project$Data$Goods$statusToIdString(x),
					idString)) {
					return elm$core$Maybe$Just(x);
				} else {
					var $temp$idString = idString,
...
var author$project$Data$Goods$statusFromIdString = function (idString) {
	return A2(author$project$Data$Goods$statusFromIdStringLoop, idString, author$project$Data$Goods$statusAll);
};
var author$project$Api$statusDecoder = A2(
	elm$json$Json$Decode$andThen,
	function (idString) {
		var _n0 = author$project$Data$Goods$statusFromIdString(idString);
		if (!_n0.$) {
			var status = _n0.a;
			...
			return elm$json$Json$Decode$fail(
				'I can\'t understand statusId=\"' + (idString + ('\" except \"' + (A2(
					elm$core$String$join,
					'\" or \"',
					A2(elm$core$List$map, author$project$Data$Goods$statusToIdString, author$project$Data$Goods$statusAll)) + '\"'))));
		}
	},
	elm$json$Json$Decode$string);
var author$project$Data$Goods$Goods = elm$core$Basics$identity;
																					...
																					return function (image3Url) {
																						return function (likedByUserList) {
																							return {
																								...
																								bc: image2Url,
																								be: image3Url,
																								bj: A2(elm$core$List$map, author$project$Data$User$userIdFromInt, likedByUserList),
																								aF: name,
																								aK: price,
																								bs: status
																							};
...
var author$project$Api$getAllGoodsResponseBodyJsonDecoder = A2(
...
var author$project$Api$getAllGoodsResponseToResult = function (response) {
	switch (response.$) {
		case 3:
			var body = response.b;
			return A2(
				...
				A2(elm$json$Json$Decode$decodeString, author$project$Api$getAllGoodsResponseBodyJsonDecoder, body));
		case 4:
			var body = response.b;
			return A2(
				elm$core$Result$withDefault,
...
var author$project$Api$urlBuilder = function (pathList) {
	return A3(elm$url$Url$Builder$crossOrigin, author$project$Api$apiOrigin, pathList, _List_Nil);
};
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{y: false, s: r.s, k: r.k, R: r.R, V: r.V, X: r.X, Y: r.Y, n: r.n}));
};
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{s: elm$http$Http$emptyBody, k: r.k, R: _List_Nil, V: 'GET', X: elm$core$Maybe$Nothing, Y: elm$core$Maybe$Nothing, n: r.n});
};
var author$project$Api$getAllGoods = function (msg) {
	return elm$http$Http$get(
		{
			k: A2(elm$http$Http$expectStringResponse, msg, author$project$Api$getAllGoodsResponseToResult),
			n: author$project$Api$urlBuilder(
				_List_fromArray(
					['v1', 'goods']))
		});
};
var author$project$Data$LogInState$LogInStateNone = {$: 1};
var author$project$Main$GetAllGoodsResponse = function (a) {
	return {$: 15, a: a};
};
...
var author$project$Data$Goods$none = {at: 1, aw: '仮の商品の説明文', aB: 0, a8: '/assets/itemDummy.png', ba: elm$core$Maybe$Nothing, bc: elm$core$Maybe$Nothing, be: elm$core$Maybe$Nothing, bj: _List_Nil, aF: '仮', aK: 23, bs: 1};
...
var elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {bg: index, bk: match, bl: number, bu: submatches};
	});
...
var author$project$Page$Component$LogInOrSignUp$initModel = {
	aa: author$project$Page$Component$LogInOrSignUp$analysisStudentIdOrEmailAddress(''),
...
var author$project$Page$Exhibition$initModel = {
	U: author$project$Page$Component$LogInOrSignUp$initModel,
	a: author$project$Page$Exhibition$EditPage(
		{at: elm$core$Maybe$Nothing, aw: '', aC: author$project$Page$Exhibition$ImageNone, aF: '', aK: elm$core$Maybe$Nothing})
};
...
var author$project$Page$Profile$Model = 0;
var author$project$Page$Profile$initModel = 0;
...
var author$project$Page$SignUp$initModel = author$project$Page$SignUp$Normal(
	{
		ad: '',
		m: author$project$Page$SignUp$StudentHasSAddress(
			{
				af: author$project$Data$Password$passwordFromString(''),
				J: author$project$Page$SignUp$analysisStudentIdOrSAddress('')
			}),
		ao: author$project$Page$SignUp$UniversitySchool(author$project$Page$SignUp$UniversitySchoolNone)
	});
var author$project$SiteMap$exhibitionGoodsPath = 'exhibition-goods';
var elm$url$Url$Parser$Parser = elm$core$Basics$identity;
var elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {t: frag, w: params, r: unvisited, o: value, x: visited};
	});
...
var author$project$Main$urlParser = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			elm$url$Url$Parser$map,
			function (_n0) {
				return author$project$Main$PageGoods(author$project$Data$Goods$none);
			},
			author$project$SiteMap$goodsParser),
			A2(
			elm$url$Url$Parser$map,
			author$project$Main$PageProfile(author$project$Page$Profile$initModel),
		...
		return _Utils_Tuple2(
			{
				ab: _List_Nil,
				T: key,
				u: author$project$Data$LogInState$LogInStateNone,
				f: elm$core$Maybe$Just(0),
				g: messageMaybe,
				a: A2(
					elm$core$Maybe$withDefault,
					author$project$Main$PageHome(1),
			...
			author$project$Api$getAllGoods(author$project$Main$GetAllGoodsResponse));
	});
...
var author$project$Data$University$universityFromIdString = function (_n0) {
	var graduateMaybe = _n0.a5;
	var departmentMaybe = _n0.a0;
	var _n1 = _Utils_Tuple2(
...
var author$project$Data$User$User = elm$core$Basics$identity;
var author$project$Data$User$make = elm$core$Basics$identity;
var author$project$Api$getUserProfileResponseValueListToResult = F5(
	function (id, nickName, introduction, departmentMaybe, graduateMaybe) {
		var _n0 = author$project$Data$University$universityFromIdString(
			{a0: departmentMaybe, a5: graduateMaybe});
		if (!_n0.$) {
			var university = _n0.a;
			return elm$core$Result$Ok(
				author$project$Data$User$make(
					{
						aB: author$project$Data$User$userIdFromInt(id),
						bi: introduction,
						ad: nickName,
						ao: university
					}));
		...
		return elm$http$Http$request(
			{
				...
				k: A2(elm$http$Http$expectStringResponse, msg, author$project$Api$getUserProfileResponseToResult),
				R: _List_fromArray(
					[
...
var author$project$Main$GetUserProfileResponse = F2(
	function (a, b) {
		return {$: 13, a: a, b: b};
	});
	...
	return _Utils_ap(
		_List_fromArray(
			[
				...
				elm$http$Http$stringPart,
				'condition',
				author$project$Data$Goods$conditionToIdString(condition)),
...
var author$project$Api$sellGoods = F3(
	function (token, createGoodsRequest, msg) {
		return elm$http$Http$request(
			{
				s: elm$http$Http$multipartBody(
					author$project$Api$createGoodsRequestJsonBody(createGoodsRequest)),
				k: A2(elm$http$Http$expectStringResponse, msg, author$project$Api$createGoodsResponseToResult),
				R: _List_fromArray(
					[
						author$project$Api$tokenToHeader(token)
					]),
...
var author$project$Main$SellGoodsResponse = function (a) {
	return {$: 14, a: a};
};
...
var elm$http$Http$post = function (r) {
	return elm$http$Http$request(
		{s: r.s, k: r.k, R: _List_Nil, V: 'POST', X: elm$core$Maybe$Nothing, Y: elm$core$Maybe$Nothing, n: r.n});
};
		...
		return elm$http$Http$post(
			{
				...
				k: A2(elm$http$Http$expectStringResponse, msg, author$project$Api$logInResponseToResult),
				n: author$project$Api$urlBuilder(
					_List_fromArray(
						['auth', 'token']))
			});
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {az: fragment, aA: host, aH: path, aJ: port_, aN: protocol, aO: query};
	});
...
var author$project$Main$exhibitionPageEmitToCmd = F2(
	function (key, emit) {
		switch (emit.$) {
			case 0:
				var e = emit.a;
			...
			case 1:
				...
				var token = _n1.a;
				var request = _n1.b;
				return A3(author$project$Api$sellGoods, token, request, author$project$Main$SellGoodsResponse);
			case 2:
				var string = emit.a;
...
var author$project$Main$logInPageEmitToCmd = function (emit) {
	var e = emit;
	return author$project$Main$logInOrSignUpEmitToCmd(e);
};
...
var author$project$Api$debugDeleteAllUser = function (msg) {
	return elm$http$Http$get(
		{
			k: A2(elm$http$Http$expectStringResponse, msg, author$project$Api$debugDeleteAllUserResponseToResult),
			n: A3(
				elm$url$Url$Builder$crossOrigin,
				author$project$Api$apiOrigin,
				_List_fromArray(
					['v1', 'debug', 'user', 'delete']),
				_List_fromArray(
					[
						A2(elm$url$Url$Builder$string, 'all', 'true')
					]))
		});
};
		...
		return elm$http$Http$post(
			{
				...
				k: A2(elm$http$Http$expectStringResponse, msg, author$project$Api$signUpResponseToResult),
				n: author$project$Api$urlBuilder(
					_List_fromArray(
						['auth', 'signup']))
			});
...
var author$project$Api$signUpConfirm = F2(
	function (_n0, msg) {
		var confirmToken = _n0.au;
		return elm$http$Http$request(
			{
				s: elm$http$Http$emptyBody,
				k: A2(elm$http$Http$expectStringResponse, msg, author$project$Api$signUpConfirmResponseToResult),
				R: _List_fromArray(
					[
...
var author$project$Main$signUpPageEmitToCmd = function (emit) {
	switch (emit.$) {
		case 0:
			var idString = emit.a;
		...
		default:
			return author$project$Api$debugDeleteAllUser(author$project$Main$DeleteAllUserResponse);
	}
};
var author$project$Page$Component$LogInOrSignUp$StopSendLogInConnection = {$: 3};
					...
					return _Utils_Tuple2(
						author$project$Page$Exhibition$EditPage(
							_Utils_update(
								rec,
								{
									aC: A2(author$project$Page$Exhibition$imageAdd, fileList, rec.aC)
								})),
						elm$core$Maybe$Nothing);
				case 2:
					var index = msg.a;
					return _Utils_Tuple2(
						author$project$Page$Exhibition$EditPage(
							_Utils_update(
								rec,
								{
									aC: A2(author$project$Page$Exhibition$imageDeleteAt, index, rec.aC)
								})),
						elm$core$Maybe$Nothing);
				case 3:
					var name = msg.a;
					...
					return _Utils_Tuple2(
						author$project$Page$Exhibition$EditPage(
							_Utils_update(
								rec,
								{
									aK: elm$core$String$toInt(priceString)
								})),
						elm$core$Maybe$Nothing);
				case 6:
					var condition = msg.a;
				...
				case 7:
					...
					return _Utils_Tuple2(
						author$project$Page$Exhibition$ConfirmPage(
							{aR: request}),
						elm$core$Maybe$Just(author$project$Page$Exhibition$EmitHistoryPushExhibitionUrl));
				case 1:
					var idString = msg.a;
					return _Utils_Tuple2(
...
var author$project$Page$Component$LogInOrSignUp$update = F2(
	function (msg, _n0) {
		...
		switch (msg.$) {
			...
			case 0:
				...
				return _Utils_Tuple2(
					_Utils_update(
						r,
						{
							aa: author$project$Page$Component$LogInOrSignUp$analysisStudentIdOrEmailAddress(string)
						}),
					elm$core$Maybe$Nothing);
			case 2:
				var request = msg.a;
			...
			default:
				return _Utils_Tuple2(r, elm$core$Maybe$Nothing);
		}
	});
	...
	function (logInState, msg, _n0) {
		...
		if (!logInState.$) {
			...
			return A3(
				...
				elm$core$Maybe$map(author$project$Page$Exhibition$EmitLogInOrSignUp),
				A2(author$project$Page$Exhibition$updateWhenNoLogIn, msg, rec.U));
		}
	});
var author$project$Page$LogIn$Msg = elm$core$Basics$identity;
var author$project$Page$LogIn$LogInOrSignUpEmit = elm$core$Basics$identity;
...
var author$project$Page$SignUp$DeleteUserAllResponse = function (a) {
	return {$: 8, a: a};
};
...
var author$project$Page$SignUp$EmitDeleteUserAll = {$: 3};
	...
	function (msg, model) {
		switch (msg.$) {
						...
						if (!model.$) {
							...
							return author$project$Page$SignUp$Normal(
								_Utils_update(
									rec,
									{
										m: A2(author$project$Page$SignUp$inputStudentIdOrEmailAddress, string, rec.m)
									}));
						} else {
							return model;
						}
						...
						if (!model.$) {
							...
							return author$project$Page$SignUp$Normal(
								_Utils_update(
									rec,
									{
										m: A2(author$project$Page$SignUp$receiveImageDataUrl, dataUrl, rec.m)
									}));
						} else {
							return model;
						}
											...
											if (_n6.$ === 1) {
												...
												return author$project$Page$SignUp$NewStudent(
													_Utils_update(
														r,
														{
															af: author$project$Data$Password$passwordFromString(string)
														}));
											} else {
												var r = _n6.a;
												return author$project$Page$SignUp$StudentHasSAddress(
						...
						if (!model.$) {
							...
							return author$project$Page$SignUp$Normal(
								_Utils_update(
									rec,
									{
										ad: elm$core$String$trim(string)
									}));
						} else {
							return model;
						}
			...
			case 7:
				return _Utils_Tuple2(
					model,
					elm$core$Maybe$Just(author$project$Page$SignUp$EmitDeleteUserAll));
			case 8:
				var response = msg.a;
				return _Utils_Tuple2(
					author$project$Page$SignUp$DeletedAllUser(
						function () {
							if (!response.$) {
								return true;
							} else {
			...
			case 9:
				...
				return _Utils_Tuple2(
					A2(author$project$Page$SignUp$SentSingUpData, signUpRequest.P, elm$core$Maybe$Nothing),
					elm$core$Maybe$Just(
...
var author$project$Main$update = F2(
	function (msg, _n0) {
		...
		switch (msg.$) {
			...
			case 5:
				var url = msg.a;
				var _n4 = A2(author$project$Main$urlToPage, rec.a, url);
				var newPageMaybe = _n4.a;
				var messageMaybe = _n4.b;
				return _Utils_Tuple2(
					function () {
						if (!newPageMaybe.$) {
							var newPage = newPageMaybe.a;
							return _Utils_update(
								rec,
								{
									f: function () {
			...
			case 7:
				...
				if (_n11.$ === 1) {
					...
					return _Utils_Tuple2(
						...
						function () {
							if (!emitMaybe.$) {
								var emit = emitMaybe.a;
								return author$project$Main$signUpPageEmitToCmd(emit);
							} else {
			...
			case 9:
				...
				if (!logInResponse.$) {
					var access = logInResponse.a.ap;
					var refresh = logInResponse.a.ai;
					return _Utils_Tuple2(
						function () {
							var _n15 = rec.a;
							switch (_n15.$) {
								case 2:
									var logInPageModel = _n15.a;
									return _Utils_update(
										rec,
										{
											g: elm$core$Maybe$Just('ログインしました'),
											a: author$project$Main$PageLogIn(
												A2(author$project$Page$LogIn$update, author$project$Page$Component$LogInOrSignUp$StopSendLogInConnection, logInPageModel).a)
										});
								case 6:
									var exhibitionModel = _n15.a;
									return _Utils_update(
										rec,
										{
											g: elm$core$Maybe$Just('ログインしました'),
											a: author$project$Main$PageExhibition(
												A3(
													...
													rec.u,
													author$project$Page$Exhibition$LogInOrSignUpMsg(author$project$Page$Component$LogInOrSignUp$StopSendLogInConnection),
													exhibitionModel).a)
										});
								default:
									return _Utils_update(
						...
						A2(
							...
							access,
							author$project$Main$GetUserProfileResponse(
								{ap: access, ai: refresh})));
				} else {
			...
			case 11:
				...
				var _n21 = rec.a;
				if (_n21.$ === 6) {
					var exhibitionPageModel = _n21.a;
					var _n22 = A2(elm$json$Json$Decode$decodeValue, author$project$Main$receiveImageFileAndBlobUrlDecoder, value);
					if (!_n22.$) {
						var data = _n22.a;
						var _n23 = A3(
							author$project$Page$Exhibition$update,
						...
						return _Utils_Tuple2(
							...
							function () {
								if (!emitMaybe.$) {
									var emit = emitMaybe.a;
									return A2(author$project$Main$exhibitionPageEmitToCmd, rec.T, emit);
								} else {
									return elm$core$Platform$Cmd$none;
								}
							}());
			...
			case 16:
				...
				var _n25 = rec.a;
				if (_n25.$ === 2) {
					var logInModel = _n25.a;
					var _n26 = A2(author$project$Page$LogIn$update, logInPageMsg, logInModel);
					var newModel = _n26.a;
					var emitMaybe = _n26.b;
					return _Utils_Tuple2(
						_Utils_update(
							rec,
							{
						...
						function () {
							if (!emitMaybe.$) {
								var emit = emitMaybe.a;
								return author$project$Main$logInPageEmitToCmd(emit);
							} else {
								return elm$core$Platform$Cmd$none;
							}
						}());
			...
			case 12:
				...
				var _n28 = rec.a;
				if (_n28.$ === 1) {
					var signUpModel = _n28.a;
					var _n29 = A2(
						author$project$Page$SignUp$update,
						author$project$Page$SignUp$DeleteUserAllResponse(response),
						signUpModel);
					var newModel = _n29.a;
					var emitMaybe = _n29.b;
					return _Utils_Tuple2(
						_Utils_update(
							rec,
							{
			...
			case 13:
				var access = msg.a.ap;
				var refresh = msg.a.ai;
				var response = msg.b;
				return _Utils_Tuple2(
					function () {
						if (!response.$) {
							var profile = response.a;
							return _Utils_update(
								rec,
								{
									u: author$project$Data$LogInState$LogInStateOk(
										{ap: access, ah: profile, ai: refresh})
								});
						} else {
							return _Utils_update(
								rec,
								{
									g: elm$core$Maybe$Just('プロフィール情報の取得に失敗しました')
								});
						}
					}(),
					elm$core$Platform$Cmd$none);
					...
					function () {
						if (!response.$) {
							return _Utils_update(
								rec,
								{
									g: elm$core$Maybe$Just('出品しました')
								});
						} else {
							return _Utils_update(
								rec,
								{
									g: elm$core$Maybe$Just('出品できませんでした')
								});
						}
					}(),
					elm$core$Platform$Cmd$none);
			...
			case 17:
				...
				var _n34 = rec.a;
				if (_n34.$ === 6) {
					var exhibitionPageModel = _n34.a;
					var _n35 = A3(author$project$Page$Exhibition$update, rec.u, exhibitionMsg, exhibitionPageModel);
					var newModel = _n35.a;
			...
			default:
				...
				var _n37 = rec.a;
				if (_n37.$ === 1) {
					var signUpPageModel = _n37.a;
					var _n38 = A2(author$project$Page$SignUp$update, signUpMsg, signUpPageModel);
					var newModel = _n38.a;
					var emitMaybe = _n38.b;
					return _Utils_Tuple2(
						_Utils_update(
							rec,
							{
...
var author$project$Main$ExhibitionMsg = function (a) {
	return {$: 17, a: a};
};
...
var author$project$Data$Goods$getFirstImageUrl = function (_n0) {
	var image0Url = _n0.a8;
	return image0Url;
};
var author$project$Data$Goods$getLikedCount = function (_n0) {
	var likedByUserList = _n0.bj;
	return elm$core$List$length(likedByUserList);
};
var author$project$Data$Goods$getName = function (_n0) {
	var name = _n0.aF;
	return name;
};
var author$project$Data$Goods$getPrice = function (_n0) {
	var price = _n0.aK;
	return price;
};
...
var author$project$Data$Goods$priceToString = function (price) {
	return A2(
		elm$core$String$join,
		',',
		function (_n0) {
...
var author$project$Page$Goods$itemImage = function (url) {
	return A2(
		elm$html$Html$img,
		_List_fromArray(
			[
...
var author$project$SiteMap$goodsUrl = function (goodsId) {
	return A2(
		elm$url$Url$Builder$absolute,
		_List_fromArray(
			[author$project$SiteMap$goodsPath, goodsId]),
		_List_Nil);
};
var elm$html$Html$div = _VirtualDom_node('div');
var author$project$Page$Goods$goodsListItem = function (goods) {
	return A2(
		elm$html$Html$a,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				author$project$Data$Goods$getFirstImageUrl(goods)),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						author$project$Data$Goods$getName(goods))
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						author$project$Data$Goods$priceToString(
							author$project$Data$Goods$getPrice(goods)))
					])),
				A2(
				elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text(
						'いいね' + elm$core$String$fromInt(
							author$project$Data$Goods$getLikedCount(goods)))
					]))
			]));
};
var elm$virtual_dom$VirtualDom$style = _VirtualDom_style;
var elm$html$Html$Attributes$style = elm$virtual_dom$VirtualDom$style;
var author$project$Page$Goods$goodsListView = F2(
	function (isWideMode, goodsList) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
			...
			A2(elm$core$List$map, author$project$Page$Goods$goodsListItem, goodsList));
	});
...
var author$project$Main$homeView = F3(
	function (goodsList, isWideScreenMode, subPage) {
		return _Utils_Tuple2(
			A2(
			...
			_List_fromArray(
				[
					A2(author$project$Page$Goods$goodsListView, isWideScreenMode, goodsList),
					author$project$Main$exhibitButton
				]));
	});
var author$project$Main$History = 1;
var author$project$Main$likeAndHistoryView = F3(
	function (goodsList, isWideScreenMode, likeAndHistory) {
		return _Utils_Tuple2(
			A2(
				author$project$Tab$Multi,
				_List_fromArray(
...
var author$project$Data$Goods$conditionToJapaneseString = function (condition) {
	switch (condition) {
		case 0:
			return '新品・未使用';
		case 1:
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$text(
									author$project$Data$Goods$priceToString(price))
								]))
						])),
					A2(
					elm$html$Html$div,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$text(
									author$project$Data$Goods$conditionToJapaneseString(condition))
								]))
						])),
					A2(
					elm$html$Html$div,
					...
					_List_fromArray(
						[
							...
							elm$html$Html$Attributes$class('exhibition-sellButton')
						]),
					_List_fromArray(
						[
...
var author$project$Page$Exhibition$selectConditionDecoder = A2(
	...
	function (index) {
		return A2(
			elm$core$Array$get,
			index - 1,
			elm$core$Array$fromList(author$project$Data$Goods$conditionAll));
	},
	A2(
					...
					function (s) {
						return A2(
							...
							_List_fromArray(
								[
									elm$html$Html$text(
									author$project$Data$Goods$conditionToJapaneseString(s))
								]));
					},
					author$project$Data$Goods$conditionAll)))
		]));
...
var author$project$Page$Exhibition$itemToRequest = function (image) {
	switch (image.$) {
		...
		case 1:
			var i0 = image.a;
			return elm$core$Maybe$Just(
				{a7: i0.a3, a9: elm$core$Maybe$Nothing, bb: elm$core$Maybe$Nothing, bd: elm$core$Maybe$Nothing});
		case 2:
			var i0 = image.a;
			var i1 = image.b;
			return elm$core$Maybe$Just(
	...
	if ((!_n1.a.$) && (!_n1.b.$)) {
		...
		if ((0 < elm$core$String$length(name)) && ((elm$core$String$length(name) <= 40) && ((0 <= p) && (p <= 1000000)))) {
			...
			if (!_n2.$) {
				...
				var image3 = _n2.a.bd;
				return elm$core$Maybe$Just(
					{at: c, aw: description, a7: image0, a9: image1, bb: image2, bd: image3, aF: name, aK: p});
			} else {
				return elm$core$Maybe$Nothing;
			}
		} else {
			...
			[
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Attributes$class('exhibition-photo-addIcon')
					]),
				_List_Nil)
			])),
		A2(
...
var author$project$Page$Exhibition$priceView = function (price) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Attributes$placeholder('0～100万'),
		...
		return _Utils_Tuple2(
			...
			_Utils_ap(
				(4 <= elm$core$List$length(
					author$project$Page$Exhibition$imageListToBlobUrlList(rec.aC))) ? _List_Nil : author$project$Page$Exhibition$photoAdd,
				_List_fromArray(
					[
						author$project$Page$Exhibition$photoCardList(
						author$project$Page$Exhibition$imageListToBlobUrlList(rec.aC)),
						author$project$Page$Exhibition$nameView,
						author$project$Page$Exhibition$descriptionView,
						author$project$Page$Exhibition$priceView(rec.aK),
...
var author$project$Page$Component$LogInOrSignUp$view = function (_n0) {
	var analysisStudentIdOrEmailAddressResult = _n0.aa;
	var password = _n0.af;
	var sending = _n0.ak;
	return A2(
		elm$html$Html$div,
		...
		return _Utils_Tuple2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('exhibition-container')
						]),
					_List_fromArray(
						[
							A2(
...
var author$project$Data$Goods$getCondition = function (_n0) {
	var condition = _n0.at;
	return condition;
};
var author$project$Data$Goods$getDescription = function (_n0) {
	var description = _n0.aw;
	return description;
};
					...
					[
						...
						_List_fromArray(
							[
								...
								author$project$Data$Goods$getDescription(goods)),
								author$project$Page$Goods$goodsViewCondition(
								author$project$Data$Goods$getCondition(goods))
							])),
						A2(
...
var author$project$Data$User$getIntroduction = function (_n0) {
	var introduction = _n0.bi;
	return introduction;
};
var author$project$Data$User$getNickName = function (_n0) {
	var nickName = _n0.ad;
	return nickName;
};
var author$project$Data$User$getUniversity = function (_n0) {
	var university = _n0.ao;
	return university;
};
...
var author$project$Data$University$universityToJapaneseString = function (university) {
	switch (university.$) {
		case 0:
			...
			return {
				O: author$project$Data$University$departmentToJapaneseString(schoolAndDepartment),
									...
									return _Utils_ap(
										_List_fromArray(
											[
												...
												author$project$Data$User$getNickName(profile)),
												author$project$Page$Profile$introductionView(
												author$project$Data$User$getIntroduction(profile))
											]),
										author$project$Page$Profile$universityView(
											author$project$Data$User$getUniversity(profile)));
								} else {
									return _List_fromArray(
										[
...
var author$project$Page$SignUp$DeleteUserAll = {$: 7};
...
var author$project$Page$SignUp$getSignUpRequestEmailAddressAndPasswordAndImage = function (sAddressAndPassword) {
	if (!sAddressAndPassword.$) {
		...
		var password = sAddressAndPassword.a.af;
		...
		var password = sAddressAndPassword.a.af;
		var imageDataUrl = sAddressAndPassword.a.S;
...
var author$project$Page$SignUp$getSignUpRequest = F3(
	function (sAddressAndPassword, university, nickName) {
		...
		if ((!_n0.a.$) && (!_n0.b.$)) {
			...
			var password = _n0.a.a.af;
			var image = _n0.a.a.aC;
			...
			return ((1 <= elm$core$String$length(nickName)) && (elm$core$String$length(nickName) <= 50)) ? elm$core$Maybe$Just(
				{P: emailAddress, aC: image, ad: nickName, W: password, ao: universityData}) : elm$core$Maybe$Nothing;
		} else {
			return elm$core$Maybe$Nothing;
		}
	});
				...
				_Utils_ap(
					...
					function () {
						if (!userSignUpSAddressAndPassword.$) {
							...
							var password = userSignUpSAddressAndPassword.a.af;
							return _List_fromArray(
								[
									elm$html$Html$Events$onClick(
										...
										A2(
											...
											_List_fromArray(
												[
													...
													'click',
													elm$json$Json$Decode$succeed(
														_Utils_Tuple2(author$project$Page$SignUp$DeleteUserAll, true)))
												]),
											_List_fromArray(
												[
		...
		if (!signUpResult.$) {
			...
			return A2(
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'送信完了。' + (author$project$Data$EmailAddress$toString(emailAddress) + ('にメールを送信しました。届いたメールのリンクをクリックして認証をしてください' + ('token = \"' + (token + '\"'))))),
						A2(
						elm$html$Html$div,
						_List_fromArray(
							[
...
var author$project$Page$SignUp$view = function (userSignUpPage) {
	var _n0 = function () {
		switch (userSignUpPage.$) {
			case 0:
				var sAddressAndPassword = userSignUpPage.a.m;
				var university = userSignUpPage.a.ao;
				var nickName = userSignUpPage.a.ad;
				return _Utils_Tuple2(
					'新規登録',
...
var author$project$Main$tabDataAndMainView = F4(
	function (goodsList, logInState, isWideScreenMode, page) {
		switch (page.$) {
			case 0:
				var subPage = page.a;
				return A2(
					...
					A3(author$project$Main$homeView, goodsList, isWideScreenMode, subPage));
			case 6:
				var subPage = page.a;
				return A3(
					elm$core$Tuple$mapBoth,
					...
					elm$core$List$map(
						elm$html$Html$map(author$project$Main$ExhibitionMsg)),
					A2(author$project$Page$Exhibition$view, logInState, subPage));
			case 3:
				var subPage = page.a;
				return A2(
					elm$core$Tuple$mapFirst,
					author$project$Tab$map(author$project$Main$PageLikeAndHistory),
					A3(author$project$Main$likeAndHistoryView, goodsList, isWideScreenMode, subPage));
			case 5:
				return _Utils_Tuple2(
			...
			case 1:
				...
				return A3(
					...
					author$project$Tab$map(elm$core$Basics$never),
					elm$core$List$map(
						elm$html$Html$map(author$project$Main$SignUpMsg)),
			...
			case 2:
				...
				return A3(
					...
					author$project$Tab$map(elm$core$Basics$never),
					elm$core$List$map(
						elm$html$Html$map(author$project$Main$LogInPageMsg)),
			...
			case 8:
				...
				return A2(
					...
					A2(
						...
						function () {
							if (!logInState.$) {
								var profile = logInState.a.ah;
								return elm$core$Maybe$Just(profile);
							} else {
								return elm$core$Maybe$Nothing;
							}
						}(),
...
var author$project$Main$mainViewAndMainTab = F4(
	function (goodsList, logInState, page, isWideScreenMode) {
		var _n0 = A4(author$project$Main$tabDataAndMainView, goodsList, logInState, isWideScreenMode, page);
		var tabData = _n0.a;
		var mainView = _n0.b;
		return _List_fromArray(
			[
...
var author$project$Main$view = function (_n0) {
	...
	var menuState = _n0.f;
	var message = _n0.g;
	var logInState = _n0.u;
	var goodsList = _n0.ab;
	...
	return {
		s: _Utils_ap(
			...
			_Utils_ap(
				A4(author$project$Main$mainViewAndMainTab, goodsList, logInState, page, isWideScreen),
				function () {
					if (!message.$) {
						var m = message.a;
						return _List_fromArray(
		...
		bw: author$project$Main$title(page)
	};
};
var elm$browser$Browser$application = _Browser_application;
var author$project$Main$main = elm$browser$Browser$application(
	{bh: author$project$Main$init, bm: author$project$Main$UrlChange, bn: author$project$Main$UrlRequest, bv: author$project$Main$subscription, bx: author$project$Main$update, by: author$project$Main$view});
