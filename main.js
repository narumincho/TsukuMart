...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.a$, request.S, true);
		} catch (e) {
...
var elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {aY: index, a_: match, a0: number, a8: submatches};
	});
		...
		_List_fromArray(
			[
				...
				author$project$Main$PageExhibition(
					{ak: '', ap: _List_Nil, aA: elm$core$Maybe$Nothing, f: ''}),
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{w: false, N: r.N, P: r.P, aU: r.aU, a$: r.a$, ba: r.ba, bb: r.bb, S: r.S}));
};
var elm$http$Http$post = function (r) {
	return elm$http$Http$request(
		{N: r.N, P: r.P, aU: _List_Nil, a$: 'POST', ba: elm$core$Maybe$Nothing, bb: elm$core$Maybe$Nothing, S: r.S});
};
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {an: fragment, ao: host, ax: path, az: port_, aD: protocol, aE: query};
	});
			...
			function () {
				...
				while (true) {
					switch (page.$) {
						...
						case 8:
							var goods = page.a;
							return author$project$Main$goodsView(goods);
						default:
							break _n0$6;
					}
				}
...
var author$project$Main$main = elm$browser$Browser$application(
	{aZ: author$project$Main$init, a1: author$project$Main$UrlChange, a2: author$project$Main$UrlRequest, a9: author$project$Main$subscription, bc: author$project$Main$update, bd: author$project$Main$view});
