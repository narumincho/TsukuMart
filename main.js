...
var author$project$Main$update = F2(
	function (msg, _n0) {
		...
		switch (msg.$) {
			...
			default:
				var string = msg.a;
				var _n4 = A2(elm$core$Debug$log, 'response', string);
				return _Utils_Tuple2(
					author$project$Main$Model(rec),
					elm$core$Platform$Cmd$none);
		}
