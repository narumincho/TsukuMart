...
var author$project$Main$bottomMenu = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('bottomMenu')
		]),
	A2(
		elm$core$List$map,
		function (text) {
			return A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('bottomMenuItem')
					]),
				_List_fromArray(
					[
