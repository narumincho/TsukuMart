...
{
	if (region.aa.G === region.am.G)
	{
		return 'on line ' + region.aa.G;
	}
	return 'on lines ' + region.aa.G + ' through ' + region.am.G;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.a1, request.S, true);
		} catch (e) {
...
var elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {a_: index, a0: match, a2: number, ba: submatches};
	});
		...
		_List_fromArray(
			[
					...
					author$project$Main$UserSignUpPageStudentHasSAddress(
						{
							...
							I: author$project$Main$analysisStudentIdOrSAddress('')
						})),
					...
					author$project$Main$LogInPage(
						{
							...
							ac: author$project$Main$analysisStudentIdOrEmailAddress('')
						})),
				...
				author$project$Main$PageExhibition(
					{al: '', aq: _List_Nil, aC: elm$core$Maybe$Nothing, f: ''}),
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{x: false, N: r.N, P: r.P, aW: r.aW, a1: r.a1, bc: r.bc, bd: r.bd, S: r.S}));
};
var elm$http$Http$post = function (r) {
	return elm$http$Http$request(
		{N: r.N, P: r.P, aW: _List_Nil, a1: 'POST', bc: elm$core$Maybe$Nothing, bd: elm$core$Maybe$Nothing, S: r.S});
};
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ao: fragment, ap: host, az: path, aB: port_, aF: protocol, aG: query};
	});
												...
												a: author$project$Main$PageSignUp(
													author$project$Main$UserSignUpPageStudentHasSAddress(
														_Utils_update(
															r,
															{
																I: author$project$Main$analysisStudentIdOrSAddress(string)
															})))
											});
									} else {
										var r = _n10.a.a;
												...
												a: author$project$Main$PageSignUp(
													author$project$Main$UserSignUpPageNewStudent(
														_Utils_update(
															r,
															{
																O: author$project$Main$analysisEmailAddress(string)
															})))
											});
									}
								case 2:
												...
												a: author$project$Main$PageLogIn(
													author$project$Main$LogInPage(
														_Utils_update(
															r,
															{
																ac: author$project$Main$analysisStudentIdOrEmailAddress(string)
															})))
											});
									} else {
										break _n10$3;
												...
												a: author$project$Main$PageSignUp(
													author$project$Main$UserSignUpPageNewStudent(
														_Utils_update(
															r,
															{
																Q: elm$core$Maybe$Just(urlString)
															})))
											});
									} else {
										break _n11$2;
...
var author$project$Main$getSignUpData = function (userSignUpPage) {
	if (!userSignUpPage.$) {
		var studentIdOrTsukubaEmailAddress = userSignUpPage.a.I;
		...
		var emailAddress = userSignUpPage.a.O;
		var password = userSignUpPage.a.g;
		var imageUrl = userSignUpPage.a.Q;
		...
		var _n0 = function () {
			switch (page.$) {
				...
				case 1:
					var subPage = page.a;
					return {
						k: author$project$Main$userSignUpView(subPage),
						l: author$project$Main$TabSingle('新規登録')
					};
				case 2:
					var subPage = page.a;
					return {
						k: author$project$Main$userLogInView(subPage),
				...
				case 7:
					...
					var response = page.b;
					return {
						k: A2(author$project$Main$sendSignUpEmailView, emailAddress, response),
						l: author$project$Main$TabNone
					};
				case 8:
					var goods = page.a;
					return {
						k: author$project$Main$goodsView(goods),
						l: author$project$Main$TabNone
					};
				default:
...
var author$project$Main$main = elm$browser$Browser$application(
	{a$: author$project$Main$init, a3: author$project$Main$UrlChange, a4: author$project$Main$UrlRequest, bb: author$project$Main$subscription, be: author$project$Main$update, bf: author$project$Main$view});
