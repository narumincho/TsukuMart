...
{
	if (region.af.L === region.au.L)
	{
		return 'on line ' + region.af.L;
	}
	return 'on lines ' + region.af.L + ' through ' + region.au.L;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.bo, request.X, true);
		} catch (e) {
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { bh: 'hidden', ba: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { bh: 'mozHidden', ba: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { bh: 'msHidden', ba: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { bh: 'webkitHidden', ba: 'webkitvisibilitychange' }
		: { bh: 'hidden', ba: 'visibilitychange' };
}
...
var author$project$Main$HomePageRecommend = function (a) {
	return {$: 1, a: a};
};
...
var elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {bk: index, bn: match, bp: number, bz: submatches};
	});
			...
			[
				...
				author$project$Main$PageSignUp(
					author$project$Main$UserSignUpPageStudentHasSAddress(
						{
							k: author$project$Password$passwordFromString(''),
							N: author$project$Main$analysisStudentIdOrSAddress('')
						})),
					...
					author$project$Main$LogInPage(
						{
							...
							ah: author$project$Main$analysisStudentIdOrEmailAddress('')
						})),
				...
				author$project$Main$PageExhibition(
					{at: '', aB: _List_Nil, aP: elm$core$Maybe$Nothing, j: ''}),
		...
		return _Utils_Tuple2(
			{
				...
				e: A2(author$project$Main$urlToPage, url, elm$core$Maybe$Nothing)
			},
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{C: false, S: r.S, U: r.U, bg: r.bg, bo: r.bo, bB: r.bB, bC: r.bC, X: r.X}));
};
var elm$http$Http$post = function (r) {
	return elm$http$Http$request(
		{S: r.S, U: r.U, bg: _List_Nil, bo: 'POST', bB: elm$core$Maybe$Nothing, bC: elm$core$Maybe$Nothing, X: r.X});
};
		...
		return elm$http$Http$post(
			{
				...
				U: A2(elm$http$Http$expectStringResponse, msg, author$project$Api$logInResponseToResult),
				X: 'http://api.tsukumart.com/auth/token/'
			});
	});
		...
		return elm$http$Http$post(
			{
				...
				U: A2(elm$http$Http$expectStringResponse, msg, author$project$Api$signUpResponseToResult),
				X: 'http://api.tsukumart.com/auth/signup/'
			});
	});
...
var author$project$Api$signUpConfirm = F2(
	function (_n0, msg) {
		var confirmToken = _n0.aq;
		return elm$http$Http$request(
			{
				S: elm$http$Http$emptyBody,
				U: A2(elm$http$Http$expectStringResponse, msg, author$project$Api$signUpConfirmResponseToResult),
				bg: _List_fromArray(
					[
				...
				X: 'http://api.tsukumart.com/auth/signup/confirm/'
			});
	});
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ay: fragment, aA: host, aM: path, aO: port_, aT: protocol, aU: query};
	});
			...
			case 7:
				...
				return _Utils_Tuple2(
					_Utils_update(
						rec,
						{
							e: A2(author$project$Main$PageSendSignUpEmail, signUpData.T, elm$core$Maybe$Nothing)
						}),
								...
								case 1:
									if (!_n10.a.$) {
										...
										return _Utils_update(
											rec,
											{
												e: author$project$Main$PageSignUp(
													author$project$Main$UserSignUpPageStudentHasSAddress(
														_Utils_update(
															r,
															{
																N: author$project$Main$analysisStudentIdOrSAddress(string)
															})))
											});
									} else {
										var r = _n10.a.a;
												...
												e: author$project$Main$PageSignUp(
													author$project$Main$UserSignUpPageNewStudent(
														_Utils_update(
															r,
															{
																T: author$project$Main$analysisEmailAddress(string)
															})))
											});
									}
								case 2:
									if (!_n10.a.$) {
										...
										return _Utils_update(
											rec,
											{
												e: author$project$Main$PageLogIn(
													author$project$Main$LogInPage(
														_Utils_update(
															r,
															{
																ah: author$project$Main$analysisStudentIdOrEmailAddress(string)
															})))
											});
									} else {
										break _n10$3;
							...
							switch (_n11.$) {
								...
								case 6:
									...
									return _Utils_update(
										rec,
										{
											e: author$project$Main$PageExhibition(
												_Utils_update(
													r,
													{
														aB: _List_fromArray(
												...
												e: author$project$Main$PageSignUp(
													author$project$Main$UserSignUpPageNewStudent(
														_Utils_update(
															r,
															{
																k: author$project$Password$passwordFromString(string)
															})))
											});
									} else {
										var r = _n13.a.a;
...
var author$project$Main$TabMulti = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
...
var author$project$Main$exhibitionView = function (_n0) {
	...
	return {
		...
		q: author$project$Main$TabSingle('商品の情報を入力')
	};
};
	...
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$text(
					'商品名' + author$project$Goods$getName(goods))
				])),
			A2(
			elm$html$Html$div,
			_List_Nil,
...
var author$project$Main$itemImage = A2(
	...
	_List_Nil);
var author$project$SiteMap$goodsUrl = function (index) {
	return '/goods/' + elm$core$String$fromInt(index);
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				author$project$SiteMap$goodsUrl(0))
			]),
		_List_fromArray(
			[
...
var jinjor$elm_xml_parser$XmlParser$escape = function (s) {
	return A3(
...
var jinjor$elm_xml_parser$XmlParser$formatDocTypeDefinition = function (def) {
	switch (def.$) {
		case 0:
			var publicIdentifier_ = def.a;
			var internalSubsetRef = def.b;
			var maybeInternalSubset = def.c;
			return 'PUBLIC \"' + (jinjor$elm_xml_parser$XmlParser$escape(publicIdentifier_) + ('\" \"' + (jinjor$elm_xml_parser$XmlParser$escape(internalSubsetRef) + ('\"' + function () {
				if (!maybeInternalSubset.$) {
					var internalSubset = maybeInternalSubset.a;
					return ' [' + (jinjor$elm_xml_parser$XmlParser$escape(internalSubset) + ']');
				} else {
					return '';
				}
			}()))));
		case 1:
			var internalSubsetRef = def.a;
			var maybeInternalSubset = def.b;
			return 'SYSTEM \"' + (jinjor$elm_xml_parser$XmlParser$escape(internalSubsetRef) + ('\"' + function () {
				if (!maybeInternalSubset.$) {
					var internalSubset = maybeInternalSubset.a;
					return ' [' + (jinjor$elm_xml_parser$XmlParser$escape(internalSubset) + ']');
				} else {
		...
		default:
			var internalSubset = def.a;
			return '[' + (jinjor$elm_xml_parser$XmlParser$escape(internalSubset) + ']');
	}
};
var jinjor$elm_xml_parser$XmlParser$formatDocType = function (docType_) {
	return '<!DOCTYPE ' + (jinjor$elm_xml_parser$XmlParser$escape(docType_.a_) + (' ' + (jinjor$elm_xml_parser$XmlParser$formatDocTypeDefinition(docType_.as) + '>')));
};
var jinjor$elm_xml_parser$XmlParser$formatAttribute = function (attribute_) {
	return jinjor$elm_xml_parser$XmlParser$escape(attribute_.aJ) + ('=\"' + (jinjor$elm_xml_parser$XmlParser$escape(attribute_.t) + '\"'));
};
var jinjor$elm_xml_parser$XmlParser$formatNode = function (node) {
	if (!node.$) {
		var tagName_ = node.a;
		var attributes_ = node.b;
		var children_ = node.c;
		return '<' + (jinjor$elm_xml_parser$XmlParser$escape(tagName_) + (' ' + (A2(
			elm$core$String$join,
			' ',
			A2(elm$core$List$map, jinjor$elm_xml_parser$XmlParser$formatAttribute, attributes_)) + (_Utils_eq(children_, _List_Nil) ? '/>' : ('>' + (A2(
			elm$core$String$join,
			'',
			A2(elm$core$List$map, jinjor$elm_xml_parser$XmlParser$formatNode, children_)) + ('</' + (jinjor$elm_xml_parser$XmlParser$escape(tagName_) + '>'))))))));
	} else {
		var s = node.a;
		return jinjor$elm_xml_parser$XmlParser$escape(s);
	}
};
var jinjor$elm_xml_parser$XmlParser$formatProcessingInstruction = function (processingInstruction_) {
	return '<?' + (jinjor$elm_xml_parser$XmlParser$escape(processingInstruction_.aJ) + (' ' + (jinjor$elm_xml_parser$XmlParser$escape(processingInstruction_.t) + '?>')));
};
var jinjor$elm_xml_parser$XmlParser$format = function (doc) {
	var pi = A2(
		elm$core$String$join,
		'',
		A2(elm$core$List$map, jinjor$elm_xml_parser$XmlParser$formatProcessingInstruction, doc.bt));
	var node = jinjor$elm_xml_parser$XmlParser$formatNode(doc.bw);
	var dt = A2(
		elm$core$Maybe$withDefault,
		'',
		A2(elm$core$Maybe$map, jinjor$elm_xml_parser$XmlParser$formatDocType, doc.bc));
	return _Utils_ap(
		pi,
		_Utils_ap(dt, node));
};
	...
	p: _List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$text(
					jinjor$elm_xml_parser$XmlParser$format(
						{
							bc: elm$core$Maybe$Nothing,
							bt: _List_Nil,
							bw: A3(jinjor$elm_xml_parser$XmlParser$Element, 'urlset', _List_Nil, _List_Nil)
						}))
				]))
		]),
	q: author$project$Main$TabSingle('sitemap.xml')
};
			...
			if (!_n0.b.$) {
				switch (_n0.a.$) {
					case 1:
						...
						return elm$core$Maybe$Just(
							{
								T: author$project$EmailAddress$fromSAddress(
...
var author$project$Main$userLogInView = function (logInPage) {
	return _List_fromArray(
		[
			...
			function () {
				if (!logInPage.$) {
					var studentIdOrEmailAddress = logInPage.a.ah;
					var password = logInPage.a.k;
...
var author$project$Main$getSignUpData = function (userSignUpPage) {
	if (!userSignUpPage.$) {
		...
		var password = userSignUpPage.a.k;
			...
			if (!_n1.b.$) {
				switch (_n1.a.$) {
					...
					case 2:
						...
						return elm$core$Maybe$Just(
							{
								T: author$project$EmailAddress$fromSAddress(sAddress),
								aB: elm$core$Maybe$Nothing,
								W: pass
							});
					default:
		...
		var emailAddress = userSignUpPage.a.T;
		var password = userSignUpPage.a.k;
								...
								[
									...
									author$project$Main$ChangePage(
										author$project$Main$PageSignUp(
											author$project$Main$UserSignUpPageNewStudent(
												{
													T: author$project$EmailAddress$fromCharList(_List_Nil),
	...
	function (page, isWideScreenMode) {
		var _n0 = function () {
			switch (page.$) {
					...
					return {
						...
						q: A2(
							...
							_List_fromArray(
								[
									_Utils_Tuple2(
									author$project$Main$PageHome(author$project$Main$HomePageRecent),
									'新着'),
									_Utils_Tuple2(
									author$project$Main$PageHome(
										author$project$Main$HomePageRecommend(
				...
				case 6:
					var subPage = page.a;
					return author$project$Main$exhibitionView(subPage);
				case 3:
					var subPage = page.a;
					return {
						p: _List_fromArray(
				...
				case 5:
					return {
						...
						q: author$project$Main$TabSingle('購入した商品')
					};
				case 4:
					return {
						p: _List_fromArray(
						...
						q: author$project$Main$TabSingle('出品した商品')
					};
				case 1:
					var subPage = page.a;
					return {
						p: author$project$Main$userSignUpView(subPage),
						q: author$project$Main$TabSingle('新規登録')
					};
				case 2:
					var subPage = page.a;
					return {
						p: author$project$Main$userLogInView(subPage),
						q: author$project$Main$TabSingle('ログイン')
					};
				case 7:
					var emailAddress = page.a;
					var response = page.b;
					return {
						p: A2(author$project$Main$sendSignUpEmailView, emailAddress, response),
						q: author$project$Main$TabNone
					};
				case 8:
					var goods = page.a;
					return {
						p: author$project$Main$goodsView(goods),
						q: author$project$Main$TabNone
					};
				default:
								...
								[
									...
									A2(
										...
										A2(
											...
											author$project$Main$tabDataToCount(tabData),
											'1fr'))),
...
var author$project$Main$main = elm$browser$Browser$application(
	{bl: author$project$Main$init, bq: author$project$Main$UrlChange, br: author$project$Main$UrlRequest, bA: author$project$Main$subscription, bD: author$project$Main$update, bE: author$project$Main$view});
