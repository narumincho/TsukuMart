...
var author$project$Main$PageExhibitionItemList = {$: 3};
var author$project$Main$PageLikeAndHistory = function (a) {
	return {$: 2, a: a};
};
var author$project$Main$PagePurchaseItemList = {$: 4};
...
var elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {q: frag, t: params, p: unvisited, l: value, u: visited};
	});
...
var author$project$Main$onUrlChange = author$project$Main$UrlChange;
var author$project$Main$UrlRequest = function (a) {
	return {$: 6, a: a};
};
var author$project$Main$onUrlRequest = author$project$Main$UrlRequest;
						...
						if (!_n2.$) {
							if (_n2.a.$ === 5) {
								...
								return _Utils_update(
									...
									{
										r: 0,
										E: author$project$Main$PageExhibition(state)
									});
							} else {
								var page = _n2.a;
								return _Utils_update(
		...
		switch (page.$) {
			case 0:
				return _List_fromArray(
					[
						_Utils_Tuple2(
						author$project$Main$PageHome(0),
						'新着'),
						_Utils_Tuple2(
						author$project$Main$PageHome(1),
						'おすすめ'),
						_Utils_Tuple2(
						author$project$Main$PageHome(2),
						'0円')
					]);
			case 2:
				return _List_fromArray(
...
var author$project$Main$main = elm$browser$Browser$application(
	{ay: author$project$Main$init, aA: author$project$Main$onUrlChange, aB: author$project$Main$onUrlRequest, aE: author$project$Main$subscription, aF: author$project$Main$update, aH: author$project$Main$view});
